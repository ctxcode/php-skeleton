...
class Response {
    ...
    public function status(int $code) {
        ...
        if ($this->request->source == 'workerman') {
            $this->sendHeaders([
                $this->request->workermanConnection->protocolVersion() . ' ' . $code . ' ' . static::getStatusText($code),
            ]);
            $this->sendBody("");
            return;
        }
    ...
    public function sendBody(string $body) {
        ...
        if ($this->request->source == 'workerman') {
            $this->request->workermanConnection->send($body);
            return;
        }
    ...
    public static function getStatusTest(int $code) {
